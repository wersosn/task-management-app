...
Projekt został wykonany przez poniżej wymienione osoby:
 ...
 - [Zapsiu](https://github.com/Zapsiu) - zaimplementował klikalny kalendarz i odznaczanie zadań jako wykonane na liście
...
The project was implemented by the following people:
 ...
 - [Zapsiu](https://github.com/Zapsiu) - implemented a clickable calendar and marking tasks as done on the task list
